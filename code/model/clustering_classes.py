...
class Point(object):
    ...
    def distance(self, other):
        ...
        for i in range(self.dimensionality()):
            sumForRoot += (other.get_attrs()[i] - self.attrs[i]) ** 2
        return sumForRoot ** 0.5
...
class Cluster(object):
    ...
    def get_centroid(self):
        ...
        center = [0 * len(self.get_points()[0])]
        for point in self.get_points():
            for i in len(center):
            #for all the dimension of the point
                center[i] += point[i]
        #take the average
        meanPt = center / len(self.get_points())
        return meanPt
...
class ClusterSet(object):
    ...
    def get_centroids(self):
        ...
        # TODO
        return [c.get_centroid() for c in self.members]
